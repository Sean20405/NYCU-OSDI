...
struct PageInfo {
    ...
    struct PageInfo *entry_in_list; // Pointer to the entry in the free list
    struct PageInfo *prev;  // Pointer to the previous page in the free list
    struct PageInfo *next;  // Pointer to the next page in the free list
};
